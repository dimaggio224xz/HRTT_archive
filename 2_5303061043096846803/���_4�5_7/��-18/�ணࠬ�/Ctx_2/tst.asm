  masm  ;Програмна модель тестування tst.asm – така назва тестової програми
   ...
   CT_L db 127,127,128, 255,255           ;Початковий стан CTL
   CT_H db 000,128,255,128, 255           ;Початковий стан CTH
    mes_1 db '1 State  CTX before testing',0dh,0ah,0ah, '$'
    mes_2 db '---------------------------------',0dh,0ah, '$'
    mes_3 db 'CTL:',20h,'$'
    mes_4 db 'CTH:',20h,'$'
   mes_5 db 'Program testing counter OT-429_06_Kozlovtsev ',0dh,0ah, '$'
   mes_6 db 'Product testing counter OT-429_06_Kozlovtsev ',0dh,0ah, '$'
   mes_7 db '  ',0dh,0ah, '$'
 mes_8 db '2 State after testing oper WHILE',0dh,0ah, 0ah,'$'
 mes_9 db '3 State after testing oper REPEAT',0dh,0ah,0ah, '$'
mes_10 db '4 State after testing oper FUNCT',0dh,0ah, 0ah,'$'
       len equ 5         ;Кількість початкових станів
