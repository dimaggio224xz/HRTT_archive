...
addps xmm0,xmm7 		 ;ADDing Packed Single precesion float point
...
exit: mov ax,4c00h
      int 21h
Opr_X DD -66.1754E-12  ;Варiанти
	    DD 9.494343E-13   ;даних
	    DD 0.34028232E+9  ;першого
	    DD -3.4028234E+19 ;операнду
Opr_Y dd 16 dup (?)    ; Резервування в памяти 16-ти елементів  підд операнд Y
	mes1 db '             TECHNOLOGI XMM ADDING THE PENTIUM PROCESSOR ',0ah,0dh,0ah,'$'
	mes2 db '     Packed_Operand_X: $'
	mes3 db '     Packed_Operand_Y: $'
	mes4 db '     Packed_Result_Z : $'
	mes5 db '       STOP TESTING TECHNOLOGI XMM ADDING THE PENTIUM PROCESSOR ',0ah,0dh,0ah,'$'
