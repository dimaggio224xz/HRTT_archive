...
time dw 3, 4, 6, 7, 8, 11, 12, 15, 16, 19, 20, 21, 24 ;Параметри процедури за-тримки
...
delay proc near        ;Процедура формування затримки
	   ...
	   mov cx, time+8	;Параметр зовнішнього циклу
  ext:push cx	        ;Буферизація параметра
	   mov cx, del+2   ;Параметр внутрішнього циклу
...
jmp rrr
   ...
   out pb, al	                    ;тетраду  порту В
           whil:in al,pa                      ;Перед умовний цикл корекції  - Читання CTX
	              ...
	              jae exec	                    ;Більше або дорівнює (CTH)>=(CTL)
    ...
    mov al,WAY_0 	;Скидання у нуль
       ...
       rrr:            out_scr  mes_3           ;Повідомлення про завершення управління
