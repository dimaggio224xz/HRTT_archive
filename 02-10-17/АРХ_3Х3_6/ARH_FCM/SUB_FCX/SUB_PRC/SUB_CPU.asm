...
Y DD - 45.754941e-5
    ...
    DD  -67.028235e+12
    DD   -5.28235e-8
MS DB '              Presentation SUBtraction Single of CPU PENTIUM start',13,10,' $ '
ME DB '               Presentation SUBtraction Single of CPU PENTIUM stop',13,10,'$ '
M1 DB '                           Operand X= $'
M2 DB '                           Operand Y= $'
M3 DB '                           Result  Z= $'
...
scr m2,si         ;Видача на екран змінної Y   
       tsz si
       jz sstp       ;Операнд  Y =  0
       xor byte ptr [si]+3,80h;Зміна знаку
       tsz di
       jnz exc      ;Операнд  Х ?  0
       exch
