format MZ			  ;Дослідження пакетного віднімання в ХММ розширенні
push cs
pop ds
push ds
pop ss
...
subps xmm0,xmm7 		 ;SUBtraction Packed Single precesion float point
...
out_str mes4					     ; Packed_Product_Z: 
 ...
 tpr:dec di
 jnz nxt
 out_str mes5			     ;STOP TESTING TECHNOLOGI XMM SUBTRACTION THE PENTIUM PROCESSOR
      mov ax,4c00h
      int 21h
...
Opr_X	DD  567.3333
    ...
    DD - 282.3095e-18
		  ...
		  Opr_Y dd 16 dup (?)	       ; Резервування в памяти 16-ти елементів  підд операнд Y
		   mm32 dd ?
	mes1 db '               TECHNOLOGY XMM SUBTRACTION THE PENTIUM PROCESSOR ',0ah,0dh,0ah,'$'
	mes2 db '       Packed_Operand_X: $'
	mes3 db '       Packed_Operand_Y: $'
	mes4 db '       Packed_Result_Z : $'
	mes5 db '         STOP TESTING TECHNOLOGY XMM SUBTRACTION THE PENTIUM PROCESSOR ',0ah,0dh,0ah,'$'
	mes6 db 0dh,'       Packed_Operand_Y: $'
