...
addps xmm0,xmm7 		 ;MULtiply Packed Single precesion float point
...
;Дискрети визначення    Underflow [-0.0000001E-38]  [+0.0000002E+38]  Overflow 
				Opr_X DD 6.1754944E-38	 ;Варiанти
				DD 6.1754946E-38   ;даних
				DD 2.4028232E+38  ;першого
				DD 2.4028234E+38  ;операнду

		  Opr_Y dd 16 dup (?)	       ; Резервування в памяти 16-ти елементів  підд операнд Y
		   mm32 dd ?
	mes1 db '               TECHNOLOGY XMM ADDITION THE PENTIUM PROCESSOR ',0ah,0dh,0ah,'$'
	mes2 db '       Packed_Operand_X: $'
	mes3 db '       Packed_Operand_Y: $'
	mes4 db '       Packed_Result_Z : $'
	mes5 db '         STOP TESTING TECHNOLOGY XMM ADDITION THE PENTIUM PROCESSOR ',0ah,0dh,0ah,'$'
