...
jmp mt1
  ...
  macro sym			  ;Вивід ASCII символу
      {push ax
       ...
       pop dx
       pop ax}
 mt1: out_str mes1                              ;TECHNOLOGI XMM MULTIPLICATION THE PENTIUM PROCESSOR 
 cursor
 cursor
...
exit: mov ax,4c00h
	...
	mes4 db '       Packed_Product_Z: $'
	mes5 db '         STOP TESTING TECHNOLOGI XMM MULTIPLICATION THE PENTIUM PROCESSOR ',0ah,0dh,'$'
