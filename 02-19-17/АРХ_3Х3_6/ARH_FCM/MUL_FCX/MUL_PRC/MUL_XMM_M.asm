...
jmp mt1
  ...
  macro sym			  ;Вивід ASCII символу
      {push ax
       ...
       pop ax}
 mt1:mov di,4
 out_str mes1				   ;START TESTINGTECHNOLOGI XMM MULTIPLICATION  THE PENTIUM PROCESSOR
 nxt: mov [mm32],1f80h
...
out_str mes4					     ; Packed_Product_Z: 
 ...
 tpr:dec di
 jnz nxt
 out_str mes5			     ;STOP TESTING TECHNOLOGI XMM MULTIPLICATION THE PENTIUM PROCESSOR
      mov ax,4c00h
      int 21h
...
Opr_X DD 1.1754943E-37;
            DD 1.1754942E-37;
            DD 3.4028234E+37;
            DD 3.4028236E+37;
		  Opr_Y dd 16 dup (?)	       ; Резервування в памяти 16-ти елементів  підд операнд Y
		   mm32 dd ?
	mes1 db '        START TESTING TECHNOLOGI XMM MULTIPLICATION  THE PENTIUM PROCESSOR ',0ah,0dh,0ah,'$'
	mes2 db '       Packed_Operand_X: $'
	mes3 db '       Packed_Operand_Y: $'
	mes4 db '       Packed_Result_Z : $'
	mes5 db '        STOP TESTING TECHNOLOGI XMM MULTIPLICATION THE PENTIUM PROCESSOR',0ah,0dh,0ah,'$'
